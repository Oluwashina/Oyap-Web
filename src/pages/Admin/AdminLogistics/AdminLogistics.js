...
const AdminLogistics = (props) => {
    ...
    const handleToggleSidebar = (value) => {
      ...
      const [tabData] = useState([
        { id: 1, name: "tab-1", text: "New Delivery"},
        { id: 2, name: "tab-2", text: "Delivery In-transit" },
        ...
        <>
         <div className="app">
            ...
            <main>
                ...
                <h5 className="mb-3 mt-3 mt-lg-0" style={{fontWeight: 'bold'}}>Logistics</h5>
                <header>
                    ...
                    {/* users layout */}
                     ...
                     <div className="newOrders mt-4">
                        ...
                        <Link to="/admin/logistics" className="next-page page-space" style={{textDecoration: 'none', color: '#323335'}}>
...
export default connect(mapStateToProps, mapDispatchToProps)(AdminLogistics);